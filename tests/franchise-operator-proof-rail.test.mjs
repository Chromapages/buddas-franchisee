...
test("OperatorProofRail renders 4-part timeline sequence with continuous rail and dots", () => {
  ...
  assert.ok(railContent.includes("The Roll creates the pull."), "Pillar 01 subheadline");
  assert.ok(railContent.includes("THE SYSTEM"), "Pillar 02 category label");
  assert.ok(railContent.includes("Built to repeat."), "Pillar 02 subheadline");
  assert.ok(railContent.includes("THE EXPERIENCE"), "Pillar 03 category label");
  assert.ok(railContent.includes("Warmth made teachable."), "Pillar 03 subheadline");
  assert.ok(railContent.includes("THE GROWTH"), "Pillar 04 category label");
  assert.ok(railContent.includes("Expansion is earned."), "Pillar 04 subheadline");
